...
function get_datetime() {
    ...
    let ms = add00(now.getMilliseconds());
...
function update_countdown() {
    ...
    && countdown_date.getHours() === 0){
        ...
        document.getElementById("countdown_div").className = "done"
    }
}
